...
export const projectThemes: Record<string, ProjectTheme> = {
  "ace-bench": {
    emoji: "⚡",
    gradient: "from-cyan-50 via-sky-50/70 to-blue-50/40 dark:from-cyan-950/70 dark:via-slate-850 dark:to-ink",
  ...
  nesrom: {
    emoji: "🕹️",
    gradient: "from-rose-50 via-orange-50/60 to-amber-50/40 dark:from-rose-950/60 dark:via-slate-850 dark:to-ink",
    accent: "border-gold/25 bg-gold/10",
    accentText: "text-gold-dim dark:text-gold",
    number: "06",
  },
